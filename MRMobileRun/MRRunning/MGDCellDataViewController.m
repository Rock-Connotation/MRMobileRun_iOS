...
- (void)savePhotoAtLocalAlbum{
    ...
    UIGraphicsBeginImageContextWithOptions(self.shareView.popView.frame.size, false, 0.0);
    [self.shareView.popView.layer renderInContext:UIGraphicsGetCurrentContext()];
    imageRet = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
    
//    UIImageView *image123 = [[UIImageView alloc] init];
//    image123.frame = CGRectMake(100, 100, 200, 200);
//    image123.backgroundColor = [UIColor redColor];
//    image123.image = imageRet;
//    [self.view addSubview:image123];
    //保存截图到本地
//    UIImageWriteToSavedPhotosAlbum(imageRet, self,  @selector(image:didFinishSavingWithError:contextInfo:), nil);
