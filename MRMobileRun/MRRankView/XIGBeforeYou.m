...
@implementation XIGBeforeYou

- (instancetype)initWithFrame:(CGRect)frame
{
    self = [super initWithFrame:frame];
    if (self) {
        UIView *view = [[[NSBundle mainBundle] loadNibNamed:@"XIGBeforeYouView" owner:self options:nil] firstObject];
        view.frame = frame;
