//
//  ZYLAcademyRankViewController.m
//  MRMobileRun
//
...
@interface ZYLAcademyRankViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation ZYLAcademyRankViewController
